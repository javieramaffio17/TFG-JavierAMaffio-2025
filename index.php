<?php	
	...
	$_SESSION['strID_Usuario'] = "0";
	$_SESSION['nroEmpleado'] = "0";
	$_SESSION['strNombre'] = "";
		...
		<div class="container">
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<button id="BotonUsuario" class="btn btn-success w-100" onclick="location.href='Login.php'">Iniciar como Usuario</button>
				</div>
			</div>
		</div>
