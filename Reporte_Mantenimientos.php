		...
		<div class="table-responsive-vertical shadow-z-1">
			<table id="table" class="table table-hover table-mc-light-blue">
				...
				<tbody>
					...
					<tr>
						<td data-title="nroTiquete"><?php echo $row["nroTiquete"]?></td>
						<td data-title="strID_Equipo"><?php echo $row["strID_Equipo"] ?></td>
						<td data-title="dtFechaIngreso"><?php echo $row["dtFechaIngreso"] ?></td>
						<td data-title="strDescripcion"><?php echo $row["strDescripcion"] ?></td>
						<td data-title="dtFechaResolucion"><?php echo $row["dtFechaResolucion"] ?></td>
						<td data-title="strSolucion"><?php echo $row["strSolucion"] ?></td>
					</tr>
					<? } ?>
				</tbody>
			</table>
