				...
				<div class="modal-body">
					<form id="Agregar" method="post" action="Nueva_Contraseña.php">
						...
						<div id="strNombreField" class="mb-3">
							...
							<input type="text" name="strNombre" id="strNombre" class="form-control" value="<? echo $strNombre; ?>" style="background-color: lightgray;" readonly>
						</div>
						<div id="strApellidosField" class="mb-3">
							<label class="form-label">Apellidos</label>
							<input type="text" name="strApellidos" id="strApellidos" class="form-control" value="<? echo $strApellidos; ?>" style="background-color: lightgray;" readonly>
						</div>
						<div id="strEmailField" class="mb-3">
							<label class="form-label">Email</label>
							<input type="email" name="strEmail" id="strEmail" class="form-control" value="<? echo $strEmail; ?>" style="background-color: lightgray;" readonly>
						</div>		
						<div id="strRolField" class="mb-3">
							<label class="form-label">Rol</label>
							<input type="text" name="strRol" id="strRol" class="form-control" value="<? echo $strRol; ?>" style="background-color: lightgray;" readonly>
						</div>
