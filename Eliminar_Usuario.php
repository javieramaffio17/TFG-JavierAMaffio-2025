			...
			<div class="modal-content">
				<div class="modal-body">
					<form id="Agregar" method="post" action="Eliminar_Usuario.php">
						...
						<input type="hidden" id="strID_Usuario_Eliminar" name="strID_Usuario_Eliminar" value="<? echo $strID_Usuario; ?>" readonly/>
						<div id="nroEmpleadoField" class="mb-3">
							<label class="form-label">Número de Empleado</label>
							<input type="text" name="nroEmpleado" id="nroEmpleado" class="form-control" value="<? echo $nroEmpleado; ?>" readonly>
						</div>
						<div id="strNombreField" class="mb-3">
							<label class="form-label">Nombre</label>
							<input type="text" name="strNombre" id="strNombre" class="form-control" value="<? echo $strNombre; ?>" readonly>
						</div>
						<div id="strApellidosField" class="mb-3">
							<label class="form-label">Apellidos</label>
							<input type="text" name="strApellidos" id="strApellidos" class="form-control" value="<? echo $strApellidos; ?>" readonly>
						</div>
						<div id="strEmailField" class="mb-3">
							<label class="form-label">Email</label>
							<input type="email" name="strEmail" id="strEmail" class="form-control" value="<? echo $strEmail; ?>" readonly>
						</div>		
						<div id="strRolField" class="mb-3">
							<label class="form-label">Rol</label>
							<input type="text" name="strRol" id="strRol" class="form-control" value="<? echo $strRol; ?>" readonly>
						</div>
						<div id="dtFechaField" class="mb-3">
							<label class="form-label">Fecha</label>
							<input type="date" name="dtFecha" id="dtFecha" class="form-control" min="<?= date('Y-m-d'); ?>" value="<? echo $dtFecha; ?>" readonly>	
						</div>	
